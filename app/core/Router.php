...
class Router
{
    ...
    public function dispatch(): void
    {
        ...
        // Recorte del base path (APP_BASE_PATH, ej. /oficios) cuando la app
        // vive bajo una subcarpeta del host. El recorte es por prefijo exacto
        // con limite de palabra para no confundir /oficios (base) con la ruta
        // legitima /oficios (modulo) ni con /oficios/oficios/123.
        $base = defined('APP_BASE_PATH') ? APP_BASE_PATH : '';
        if ($base !== '') {
            if ($uri === $base) {
                // /oficios (sin slash final) -> ruta raiz "/"
                $uri = '/';
