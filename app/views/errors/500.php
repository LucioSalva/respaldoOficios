...
<link rel="stylesheet" href="<?= function_exists('asset_url') ? asset_url('css/app.css') : '/assets/css/app.css' ?>">
</head>
<body>
<main class="container py-5" role="main">
    <div class="mx-auto text-center" style="max-width:640px;">
        ...
        <?php endif; ?>
        <a href="<?= function_exists('url_path') ? url_path('/dashboard') : '/dashboard' ?>" class="btn btn-institucional mt-3">
