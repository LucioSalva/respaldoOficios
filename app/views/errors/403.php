...
<head>
    ...
    <title>Acceso denegado — Respaldo de Oficios</title>
...
<div class="min-vh-100 d-flex align-items-center justify-content-center">
    <div class="text-center">
        <i class="fa-solid fa-shield-halved text-danger" style="font-size:5rem;"></i>
        <h1 class="display-4 fw-bold text-danger mt-3">403</h1>
        <p class="fs-4 text-muted mb-4">No tienes permisos para acceder a esta sección.</p>
