...
// Construir Ã­ndice de flags por clave para que el JS tome la verdad del backend.
...
<form method="POST" action="<?= url_path('/oficios/crear') ?>" enctype="multipart/form-data" novalidate>
...
<div class="card border-0 shadow-sm mb-4" id="cardTipoOficio">
    <div class="card-header bg-institucional text-white py-3">
        <h2 class="h5 fw-bold mb-0">
            <i class="fa-solid fa-circle-question me-2"></i>Â¿QuÃ© tipo de oficio desea registrar?
        </h2>
    </div>
            ...
            <div class="col-12 col-md-4">
                <label class="tipo-oficio-radio w-100 d-block p-4 rounded-3 text-center"
                    ...
                    <p class="mb-0 text-muted">
                        ...
                        (H. Ayuntamiento, Obras PÃºblicas, SecretarÃ­a, etc.)
                    </p>
                </label>
            </div>
            <div class="col-12 col-md-4">
                <label class="tipo-oficio-radio w-100 d-block p-4 rounded-3 text-center"
                    ...
                    <p class="h4 fw-bold mb-1" style="color:var(--dorado-oscuro)">Oficio interno de TesorerÃ­a</p>
                    <p class="mb-0 text-muted">
                        Generado por un <strong>Ã¡rea interna</strong> de TesorerÃ­a<br>
                        (SubdirecciÃ³n de Egresos, JurÃ­dico, etc.)
                    </p>
                </label>
            </div>
            <div class="col-12 col-md-4">
                <label class="tipo-oficio-radio w-100 d-block p-4 rounded-3 text-center"
                    ...
                    <p class="mb-0 text-muted">
                        ...
                        No requiere contestaciÃ³n.
                    </p>
                </label>
            </div>
        </div>
        <!-- Banner dinÃ¡mico para CONOCIMIENTO -->
        <div class="alert alert-info border-0 mt-3 mb-0 py-3 d-none" id="bannerConocimiento">
            <i class="fa-solid fa-circle-info me-2"></i>
            <strong>Este oficio se registra solo para conocimiento y no requiere contestaciÃ³n.</strong>
        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-md-6 bloque-interno" style="display:none;">
                ...
                <select class="form-select form-select-lg <?= isset($errors['area_interna_id']) ? 'is-invalid' : '' ?>"
                    ...
                    <option value="">-- Selecciona un Ã¡rea interna --</option>
                ...
                <small class="text-muted">
                    ...
                    Â¿No aparece el Ã¡rea? Solicita a un Administrador que la dÃ© de alta en
                    <a href="<?= url_path('/catalogos#areas-internas') ?>">CatÃ¡logos â†’ Ãreas Internas</a>.
                </small>
            </div>
            ...
            <div class="col-12 bloque-interno" style="display:none;">
                ...
                <input type="text"
                       ...
                       placeholder="Ej: TM/ECA/STIyC/01/2026  Ã³  SDTICS/002/02/2026  Ã³  TM/STIYC/008/2026">
                <small class="text-muted">
            ...
            <div class="col-12">
                <div class="alert alert-warning border-0 mb-0 py-2 small">
                    ...
                    Si los dejas vacÃ­os, el oficio se guardarÃ¡ como <span class="badge bg-warning text-dark">pendiente</span> (estatus "En Proceso") con folio auto-asignado.
                </div>
            </div>

            <!-- ZONA PENDIENTE â€” Folio + Fecha Oficio TICs + RealizÃ³ + Fecha Acuse -->
            <div class="col-12">
                <div class="folio-zona p-3 rounded-3" id="folioZona"
                    ...
                    <div class="alert alert-warning border-0 mb-3 py-2 small">
                        <i class="fa-solid fa-triangle-exclamation me-1"></i>
                        <strong>Â¿TodavÃ­a no tienes el Folio de TesorerÃ­a, la Fecha de Oficio TICs, el nombre de quien realizÃ³ o la Fecha de Acuse?</strong>
                        DÃ©jalos vacÃ­os: el oficio se guardarÃ¡ como <strong>PENDIENTE</strong> y podrÃ¡s capturarlos despuÃ©s desde la ediciÃ³n del oficio.
                    </div>

                    <!-- Folio de TesorerÃ­a (SOLO EXTERNO) -->
                    <div class="bloque-externo">
                        <p class="fw-bold text-institucional mb-2 mt-2">
                            <i class="fa-solid fa-hashtag me-1"></i> Folio de TesorerÃ­a
                        </p>
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-12 col-md-8">
                                ...
                                <small class="text-muted">
                                    <i class="fa-solid fa-circle-info me-1"></i>
                                    Escribe <strong>solo el nÃºmero</strong> (las XXXX) cuando lo tengas. El prefijo <strong>TM/ECA/STIyC</strong> y el aÃ±o se arman solos.
                                </small>
                            </div>
                        </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 col-md-4">
                            <label for="fecha_acuse" class="form-label fw-bold">
                                <i class="fa-solid fa-stamp"></i> Fecha Acuse OficialÃ­a TesorerÃ­a
                            </label>
                            <input type="date"
                                   class="form-control form-control-lg"
            ...
            <div class="col-12 col-md-6">
                ...
                <select class="form-select form-select-lg <?= isset($errors['estado_id']) ? 'is-invalid' : '' ?>"
                    ...
                    <option value="">â€” Pendiente (En Proceso) â€”</option>
                ...
                <?php endif; ?>
                <small class="text-muted">Si se deja vacÃ­o, el oficio queda <strong>pendiente</strong> en estatus "En Proceso".</small>
            </div>
    ...
    <div class="card-body p-4">
        <div class="row g-3 align-items-center">
            <div class="col-12 col-md-8">
                ...
                <small class="text-muted">
                    <i class="fa-solid fa-circle-info me-1"></i>
                    Solo archivos PDF. TamaÃ±o mÃ¡ximo: 10 MB.
                </small>
            </div>
            <div class="col-12 col-md-4">
...
<div class="d-flex gap-3 flex-wrap pb-4">
    ...
    <a href="<?= url_path('/oficios') ?>" class="btn btn-outline-institucional btn-lg px-5 py-3">
...
(function () {
    ...
    function aplicar(radioSeleccionado) {
        ...
        // required dinÃ¡mico (server-side manda; esto solo ayuda al usuario)
