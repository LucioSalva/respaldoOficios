    ...
    <div>
        ...
        <div class="d-flex align-items-center gap-3 flex-wrap">
            ...
            <span class="text-muted">
                Registrado: <?= $oficio['created_at'] ? date('d/m/Y H:i', strtotime($oficio['created_at'])) : 'â€”' ?>
            </span>
        </div>
    </div>
    <div class="d-flex gap-2 flex-wrap">
        <a href="<?= url_path('/oficios/'.$oficio['id'].'/editar') ?>" class="btn btn-outline-secondary btn-lg">
        ...
        <form method="POST" action="<?= url_path('/oficios/'.$oficio['id'].'/eliminar') ?>" class="m-0"
              data-confirm="Se eliminarÃ¡ permanentemente el oficio <strong><?= htmlspecialchars($__folioDel) ?></strong> junto con sus movimientos y PDFs. Esta acciÃ³n no se puede deshacer."
        ...
        <?php endif; ?>
        <a href="<?= url_path('/oficios') ?>" class="btn btn-outline-primary btn-lg">
...
<div class="alert alert-success border-0 shadow-sm mb-4 d-flex align-items-center gap-3" style="border-left:6px solid #198754 !important;">
    ...
    <div>
        <div class="fw-bold fs-5 text-success-emphasis">No requiere contestaciÃ³n</div>
        <div class="text-muted">
            Este oficio se registrÃ³ Ãºnicamente para <strong>conocimiento</strong>.
    ...
    <div class="col-12 col-xl-8">
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-12 col-md-6">
                        <p class="text-muted small mb-1">
                            <?= $es_interno ? 'Folio Oficio TICS (interno)' : 'Folio TesorerÃ­a' ?>
                        </p>
                        <p class="fw-bold fs-5 text-institucional mb-0">
                            <?php if ($es_interno): ?>
                                <?= htmlspecialchars($oficio['folio_interno_texto'] ?: 'â€”') ?>
                            <?php else: ?>
                    ...
                    <div class="col-12 col-md-6">
                        <?php if ($es_interno): ?>
                            <p class="text-muted small mb-1">Ãrea Interna</p>
                            <p class="fw-semibold mb-0">
                                <i class="fa-solid fa-house-chimney me-1" style="color:var(--dorado-oscuro)"></i>
                                <?= htmlspecialchars($oficio['area_interna_nombre'] ?? 'â€”') ?>
                            </p>
                        ...
                        <?php else: ?>
                            ...
                            <p class="fw-semibold mb-0">
                                ...
                                <?= htmlspecialchars($oficio['dependencia_nombre'] ?? 'â€”') ?>
                            </p>
                        <?php endif; ?>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        <p class="text-muted small mb-1">DescripciÃ³n</p>
                ...
                <div class="row g-3">
                    <div class="col-6 col-md-3">
                        ...
                        <p class="fw-semibold mb-0"><?= htmlspecialchars($oficio['folio_minutario'] ?? 'â€”') ?></p>
                    </div>
                    <div class="col-6 col-md-5">
                        <p class="text-muted small mb-1">Folio DirecciÃ³n</p>
                        <p class="fw-semibold mb-0 text-truncate"><?= htmlspecialchars($oficio['folio_direccion'] ?? 'â€”') ?></p>
                    </div>
                    <div class="col-6 col-md-4">
                        <p class="text-muted small mb-1">RealizÃ³</p>
                        <p class="fw-semibold mb-0"><?= htmlspecialchars($oficio['realizo'] ?? 'â€”') ?></p>
                    </div>
                    <div class="col-6 col-md-3">
                        <p class="text-muted small mb-1">CapturÃ³</p>
                        <p class="fw-semibold mb-0"><?= htmlspecialchars($oficio['capturo_nombre'] ?? 'â€”') ?></p>
                    </div>
                    <div class="col-6 col-md-3">
                        <p class="text-muted small mb-1">Responsable</p>
                        <p class="fw-semibold mb-0"><?= htmlspecialchars($oficio['responsable_nombre'] ?? 'â€”') ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-6 col-md-3">
                        <p class="text-muted small mb-1">RecepciÃ³n</p>
                        <p class="fw-semibold mb-0">
                            <?= $oficio['fecha_recepcion'] ? date('d/m/Y', strtotime($oficio['fecha_recepcion'])) : 'â€”' ?>
                        </p>
                    </div>
                    ...
                    <div class="col-6 col-md-3">
                        ...
                        <?php else: ?><p class="fw-semibold mb-0">â€”</p><?php endif; ?>
                    </div>
                    <?php endif; ?>
                    <div class="col-6 col-md-3">
                        <p class="text-muted small mb-1">Oficio TICs</p>
                        <p class="fw-semibold mb-0">
                            <?= $oficio['fecha_oficio_tics'] ? date('d/m/Y', strtotime($oficio['fecha_oficio_tics'])) : 'â€”' ?>
                        </p>
                    </div>
                    <div class="col-6 col-md-3">
                        <p class="text-muted small mb-1">Acuse Recibido</p>
                        <p class="fw-semibold mb-0">
                            <?= $oficio['fecha_acuse'] ? date('d/m/Y', strtotime($oficio['fecha_acuse'])) : 'â€”' ?>
                        </p>
                    </div>
                    <?php if ($flag_requiere_respuesta && $oficio['fecha_resolucion']): ?>
                    <div class="col-6 col-md-3">
                        <p class="text-muted small mb-1">ResoluciÃ³n</p>
        ...
        <div class="card border-0 shadow-sm mb-4" id="movimientos">
            ...
            <div class="collapse <?= !empty($mov_errors) ? 'show' : '' ?>" id="formMovimiento">
                <div class="card-body border-bottom bg-light">
                    ...
                    <?php endif; ?>
                    <form method="POST" action="<?= url_path('/oficios/'.$oficio['id'].'/movimiento') ?>" novalidate>
                        <input type="hidden" name="csrf_token" value="<?= htmlspecialchars(Auth::csrfToken()) ?>">
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-5">
                                <label for="mov_observacion" class="form-label fw-semibold">
                                    ObservaciÃ³n <span class="text-danger">*</span>
                                </label>
                        ...
                        <div class="d-flex align-items-start gap-3">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <small class="text-muted">
                                    ...
                                    <?= $mov['fecha'] ? date('d/m/Y H:i', strtotime($mov['fecha'])) : 'â€”' ?>
                                </small>
                            </div>
                        </div>
                    </div>
    ...
    <div class="col-12 col-xl-4">
        ...
        <div class="card border-0 shadow-sm mb-4" id="evidencias">
            ...
            <div class="collapse" id="formEvidencia">
                <div class="card-body border-bottom bg-light">
                    <form method="POST" action="<?= url_path('/oficios/'.$oficio['id'].'/evidencia') ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">MÃ¡ximo 10 MB. Solo archivos PDF.</small>
                        </div>
                        ...
                        <div class="d-flex align-items-start gap-2">
                            ...
                            <div class="flex-grow-1 overflow-hidden">
                                ...
                                <small class="text-muted">
                                    ...
                                    por <?= htmlspecialchars($ev['usuario_nombre'] ?? 'â€”') ?>
                                </small>
                            </div>
                        </div>
                        <div class="mt-2 d-flex gap-2">
                            <a href="<?= url_path('/evidencia/'.$ev['id'].'/ver') ?>" target="_blank"
                               class="btn btn-sm btn-outline-primary">
                                <i class="fa-solid fa-eye me-1" aria-hidden="true"></i>Ver
                            </a>
                            <a href="<?= url_path('/evidencia/'.$ev['id'].'/descargar') ?>"
        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between py-2">
                    <span class="text-muted">Ãšltima actualizaciÃ³n</span>
                    <small class="text-muted"><?= $oficio['updated_at'] ? date('d/m/Y', strtotime($oficio['updated_at'])) : 'â€”' ?></small>
                </div>
            </div>
        </div>
    </div>
