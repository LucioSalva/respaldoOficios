...
<div class="alert alert-warning">
    <strong>Importante:</strong> La importaciÃ³n real se realiza desde la terminal con los
...
<div class="card border-0 shadow-sm mb-3">
    ...
    <div class="card-body">
        <form method="POST" action="<?= url_path('/importar/subir') ?>" enctype="multipart/form-data" class="row g-3 align-items-end">
            <input type="hidden" name="csrf_token" value="<?= htmlspecialchars(Auth::csrfToken()) ?>">
            <div class="col-md-8">
                <label for="excel" class="form-label fw-semibold">Archivo Excel (.xlsx, mÃ¡ximo 12 MB)</label>
            ...
            <div class="col-12 small text-muted">
                ...
                DespuÃ©s, ejecute el script Python correspondiente en el servidor para procesarlo.
            </div>
        </form>
    </div>
</div>

<!-- EstadÃ­sticas staging -->
        ...
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body">
                ...
                <div class="row g-2 small">
                    <div class="col-6">
                        <div class="text-muted">LeÃ­dos</div>
                    ...
                    <div class="col-6">
                        <div class="text-muted">En revisiÃ³n</div>
...
<div class="card border-0 shadow-sm mb-3">
    ...
    <div class="card-body">
        <p class="mb-2">Desde la raÃ­z del proyecto, y con acceso a la base de datos PostgreSQL:</p>
...
# Oficios de Conocimiento (buzÃ³n interno)
...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white py-3">
        <h2 class="h5 mb-0"><i class="fa-solid fa-circle-exclamation me-2"></i>Ãšltimos errores / pendientes de revisiÃ³n</h2>
    </div>
        ...
        <table class="table table-sm table-hover mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="small"><?= htmlspecialchars($e['fuente'] ?? 'â€”') ?></td>
