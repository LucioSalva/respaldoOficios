...
<div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
    ...
    <div class="d-flex gap-2">
        <a href="<?= url_path('/incidencias?pendientes=1') ?>" class="btn btn-outline-warning btn-lg">
            <i class="fa-solid fa-circle-exclamation me-1"></i>
            Pendientes de revisiÃ³n (<?= (int)($resumen['pendientes'] ?? 0) ?>)
        </a>
        <a href="<?= url_path('/incidencias/crear') ?>" class="btn btn-institucional btn-lg">
        ...
        <div class="row g-2">
            <?php foreach ($porTipo as $t): ?>
                ...
                <div class="col-md-3 col-sm-6">
                    <a href="<?= url_path('/incidencias?tipo_id='.(int)$t['tipo_id']) ?>"
...
<div class="card border-0 shadow-sm mb-3">
    <div class="card-body">
        <form method="GET" action="<?= url_path('/incidencias') ?>" class="row g-2 align-items-end">
            <div class="col-md-3">
            ...
            <div class="col-md-2">
                <label for="f_anio" class="form-label fw-semibold">AÃ±o</label>
            ...
            <div class="col-md-2">
                ...
                <select id="f_quin" name="quincena" class="form-select form-select-lg">
                    ...
                    <option value="1" <?= (string)$filtros['quincena'] === '1' ? 'selected' : '' ?>>1Âª (1-15)</option>
                    <option value="2" <?= (string)$filtros['quincena'] === '2' ? 'selected' : '' ?>>2Âª (16-fin)</option>
                </select>
            </div>
            ...
            <div class="col-12 d-flex gap-2">
                ...
                <a href="<?= url_path('/incidencias') ?>" class="btn btn-outline-secondary btn-lg">Limpiar</a>
            </div>
        </form>
    </div>
</div>
    ...
    <div class="table-responsive">
        <table class="table table-hover table-lg mb-0" aria-label="Incidencias">
            ...
            <tbody>
                ...
                <tr>
                    <td class="ps-4">
                        <a href="<?= url_path('/personal/'.(int)$i['personal_id']) ?>" class="text-decoration-none">
                            <div class="fw-semibold text-dark"><?= htmlspecialchars($i['nombre_completo']) ?></div>
                            <small class="text-muted">NÂ° <?= htmlspecialchars($i['numero_empleado'] ?? 'â€”') ?></small>
                        </a>
                    </td>
                    <td>
                    ...
                    <td class="pe-4 text-center">
                        <a href="<?= url_path('/incidencias/'.(int)$i['id']) ?>" class="btn btn-sm btn-outline-secondary" title="Ver detalle">
                            <i class="fa-solid fa-eye"></i>
                        </a>
                        <?php if (Auth::hasRole([ROL_GOD, ROL_ADMIN])): ?>
                        <a href="<?= url_path('/incidencias/'.(int)$i['id'].'/editar') ?>" class="btn btn-sm btn-outline-primary" title="Editar">
