...
<div class="card border-0 shadow-sm">
    <div class="card-body">
        <form method="POST" action="<?= url_path('/incidencias/crear') ?>" novalidate>
            ...
            <div class="row g-3">
                <div class="col-md-8">
                    ...
                    <select id="personal_id" name="personal_id" required
                        ...
                        <option value="">Seleccione un empleadoâ€¦</option>
                        <?php foreach ($personal as $p): ?>
                            ...
                            <option value="<?= (int)$p['id'] ?>" <?= $sel ? 'selected' : '' ?>>
                                ...
                                â€” NÂ° <?= htmlspecialchars($p['numero_empleado'] ?? 's/n') ?>
                ...
                <div class="col-md-4">
                    <label for="fecha_inicio" class="form-label fw-semibold">DÃ­a a justificar (inicio)</label>
                ...
                <div class="col-md-4">
                    <label for="fecha_fin" class="form-label fw-semibold">DÃ­a a justificar (fin)</label>
                ...
                <div class="col-md-4">
                    <label for="fecha_recibido_coord" class="form-label fw-semibold">Recibido por coordinaciÃ³n</label>
                ...
                <div class="col-md-2">
                    <label for="anio" class="form-label fw-semibold">AÃ±o</label>
                ...
                <div class="col-md-2">
                    ...
                    <select id="quincena" name="quincena" class="form-select form-select-lg">
                        ...
                        <option value="1" <?= (string)($old['quincena'] ?? '') === '1' ? 'selected' : '' ?>>1Âª (1-15)</option>
                        <option value="2" <?= (string)($old['quincena'] ?? '') === '2' ? 'selected' : '' ?>>2Âª (16-fin)</option>
                    </select>
                </div>
                ...
                <div class="col-md-6">
                    <label for="folio_justificacion" class="form-label fw-semibold">Folio de justificaciÃ³n (opcional)</label>
                ...
                <div class="col-12">
                    <label for="motivo" class="form-label fw-semibold">Motivo / descripciÃ³n breve</label>
                ...
                <div class="col-12">
                    <label for="justificacion" class="form-label fw-semibold">JustificaciÃ³n formal (opcional)</label>
                    ...
                    <small class="text-muted">Si captura una justificaciÃ³n, el estatus se cambia normalmente a "Justificada".</small>
                </div>
            </div>
            ...
            <div class="d-flex gap-2 mt-4">
                ...
                <a href="<?= url_path('/incidencias') ?>" class="btn btn-outline-secondary btn-lg">Cancelar</a>
            </div>
        </form>
    </div>
</div>
...
(function () {
    ...
    function paint() {
        ...
        info.innerHTML = '<i class="fa-solid fa-id-card me-1"></i>' +
            'NÂ° <strong>' + (d.num || 's/n') + '</strong> Â· ' +
            'Tipo: <strong>' + (d.tipo || 'â€”') + '</strong>';
    }
