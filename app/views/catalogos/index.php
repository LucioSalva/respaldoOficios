<?php $pageTitle = 'CatÃ¡logos'; ?>

<div class="d-flex align-items-center justify-content-between mb-4">
    <h1 class="h2 fw-bold text-institucional mb-0">
        <i class="fa-solid fa-table-list me-2" aria-hidden="true"></i>CatÃ¡logos del Sistema
    </h1>
</div>
...
<ul class="nav nav-tabs nav-tabs-lg mb-4" id="catalogosTabs" role="tablist">
    ...
    <li class="nav-item" role="presentation">
        <a class="nav-link fs-5 fw-semibold" id="ai-tab" href="#areas-internas"
           data-bs-toggle="tab" role="tab">
            <i class="fa-solid fa-house-chimney me-2" aria-hidden="true"></i>Ãreas Internas
        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-lg-4">
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?= url_path('/catalogos/dependencias') ?>" novalidate>
                    ...
                    <div class="table-responsive" style="max-height:500px; overflow-y:auto;">
                        <table class="table table-hover mb-0">
                            ...
                            <tr class="<?= !$dep['activo'] ? 'table-secondary opacity-75' : '' ?>">
                                ...
                                <td><span class="badge bg-light text-dark border"><?= htmlspecialchars($dep['clave'] ?? 'â€”') ?></span></td>
                                <td>
                                ...
                                <td class="text-center">
                                    <div class="d-flex gap-1 justify-content-center">
                                        ...
                                        <!-- Toggle activo -->
                                        <form method="POST" action="<?= url_path('/catalogos/dependencias/'.$dep['id'].'/toggle') ?>"
                                              data-confirm="<?= $dep['activo'] ? 'Â¿Desactivar' : 'Â¿Activar' ?> la dependencia <strong><?= htmlspecialchars($dep['nombre']) ?></strong>?"
        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-lg-4">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-institucional-light py-3">
                        <h2 class="h5 fw-bold mb-0 text-institucional">
                            <i class="fa-solid fa-circle-plus me-2" aria-hidden="true"></i>Agregar Ãrea Interna
                        </h2>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="<?= url_path('/catalogos/areas-internas') ?>" novalidate>
                            <input type="hidden" name="csrf_token" value="<?= htmlspecialchars(Auth::csrfToken()) ?>">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg"
                                       ...
                                       placeholder="Ej: SubdirecciÃ³n de Egresos" required>
                            </div>
                            <div class="mb-3">
            ...
            <div class="col-12 col-lg-8">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white border-bottom py-3">
                        <h2 class="h6 fw-bold mb-0 text-muted">Lista de Ãreas Internas de TesorerÃ­a</h2>
                    </div>
                    <div class="table-responsive" style="max-height:500px; overflow-y:auto;">
                        <table class="table table-hover mb-0">
                            <thead class="table-light sticky-top">
                            ...
                            <tr class="<?= !$ai['activo'] ? 'table-secondary opacity-75' : '' ?>">
                                ...
                                <td><span class="badge bg-light text-dark border"><?= htmlspecialchars($ai['clave'] ?? 'â€”') ?></span></td>
                                <td>
                                ...
                                <td class="text-center">
                                    <div class="d-flex gap-1 justify-content-center">
                                        ...
                                        <form method="POST" action="<?= url_path('/catalogos/areas-internas/'.$ai['id'].'/toggle') ?>"
                                              data-confirm="<?= $ai['activo'] ? 'Â¿Desactivar' : 'Â¿Activar' ?> el Ã¡rea interna <strong><?= htmlspecialchars($ai['nombre']) ?></strong>?"
                                              data-confirm-icon="question">
                                            <input type="hidden" name="csrf_token" value="<?= htmlspecialchars(Auth::csrfToken()) ?>">
        ...
        <div class="row g-4">
            <div class="col-12 col-lg-4">
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?= url_path('/catalogos/estados') ?>" novalidate>
                            <input type="hidden" name="csrf_token" value="<?= htmlspecialchars(Auth::csrfToken()) ?>">
                            <div class="mb-3">
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <form method="POST" action="<?= url_path('/catalogos/estados/'.$est['id'].'/toggle') ?>"
                                      data-confirm="<?= $est['activo'] ? 'Â¿Desactivar' : 'Â¿Activar' ?> el estado <strong><?= htmlspecialchars($est['nombre']) ?></strong>?"
                                      data-confirm-icon="question">
                                    <input type="hidden" name="csrf_token" value="<?= htmlspecialchars(Auth::csrfToken()) ?>">
        ...
        <div class="row g-4">
            <div class="col-12 col-lg-4">
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?= url_path('/catalogos/tipos-evidencia') ?>" novalidate>
                            <input type="hidden" name="csrf_token" value="<?= htmlspecialchars(Auth::csrfToken()) ?>">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="te_desc" class="form-label fw-semibold">DescripciÃ³n</label>
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tr>
                            ...
                            <td class="text-muted"><?= htmlspecialchars($te['descripcion'] ?? 'â€”') ?></td>
                            <td>
                            ...
                            <td class="text-center">
                                <form method="POST" action="<?= url_path('/catalogos/tipos-evidencia/'.$te['id'].'/toggle') ?>"
                                      data-confirm="<?= $te['activo'] ? 'Â¿Desactivar' : 'Â¿Activar' ?> el tipo de evidencia <strong><?= htmlspecialchars($te['nombre']) ?></strong>?"
                                      data-confirm-icon="question">
                                    <input type="hidden" name="csrf_token" value="<?= htmlspecialchars(Auth::csrfToken()) ?>">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" id="editAreaForm" novalidate>
                <input type="hidden" name="csrf_token" value="<?= htmlspecialchars(Auth::csrfToken()) ?>">
                <div class="modal-header">
                    <h5 class="modal-title fw-bold" id="editAreaModalLabel">Editar Ãrea Interna</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <div class="mb-3">
...
<script>
// Activar tab segÃºn hash de URL
