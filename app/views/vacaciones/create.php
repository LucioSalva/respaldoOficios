...
<form method="POST" action="<?= url_path('/vacaciones/crear') ?>" class="card border-0 shadow-sm">
    ...
    <div class="card-body">
        <div class="row g-4">
            ...
            <div class="col-md-12">
                ...
                <div class="input-group input-group-lg">
                    ...
                    <input type="text" id="empleado_busqueda" class="form-control form-control-lg"
                           placeholder="Escribe nÃºmero o nombre del empleado"
                           autocomplete="off"
            ...
            <div class="col-md-4">
                <label for="fecha_recibido_coord" class="form-label fw-semibold fs-5">Recibido por coordinaciÃ³n</label>
            ...
            <!-- Dias -->
            <div class="col-md-4">
                <label for="dias_corresponden" class="form-label fw-semibold fs-5">DÃ­as que corresponden</label>
            ...
            <div class="col-md-4">
                <label for="dias_tomados" class="form-label fw-semibold fs-5">DÃ­as otorgados</label>
            ...
            <div class="col-md-4">
                <label for="dias_pendientes_excel" class="form-label fw-semibold fs-5">DÃ­as pendientes (referencia)</label>
                <input type="number" id="dias_pendientes_excel" name="dias_pendientes_excel"
                       min="0" max="366"
                       class="form-control form-control-lg"
                       value="<?= htmlspecialchars($old['dias_pendientes_excel'] ?? '') ?>">
                <small class="text-muted">Si lo llenas y no coincide con el cÃ¡lculo, se marcarÃ¡ como inconsistencia.</small>
            </div>
    ...
    <div class="card-footer bg-white py-3 d-flex justify-content-end gap-2">
        <a href="<?= url_path('/vacaciones') ?>" class="btn btn-outline-secondary btn-lg">Cancelar</a>
...
(function () {
    ...
    inp.addEventListener('input', function(){
        ...
        t = setTimeout(function(){
            fetch(window.appPath('/vacaciones/buscar-personal?q=' + encodeURIComponent(q)))
                .then(r => r.json())
                .then(j => {
                    list.innerHTML = '';
                    (j.data || []).forEach(function(r){
                        ...
                        a.innerHTML = '<strong>' + (r.numero_empleado || 'â€”') + '</strong> â€” ' +
                                      (r.nombre_completo || '') +
