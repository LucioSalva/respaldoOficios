...
<div class="d-flex align-items-center gap-2 mb-3 flex-wrap">
    <a href="<?= url_path('/vacaciones/empleado/'.(int)$mov['personal_id']) ?>" class="btn btn-outline-secondary btn-lg">
...
<form method="POST" action="<?= url_path('/vacaciones/mov/'.(int)$mov['id'].'/editar') ?>" class="card border-0 shadow-sm">
    ...
    <div class="card-body">
        <div class="alert alert-light border fs-5">
            ...
            <small class="text-muted ms-2">NÂ° <?= htmlspecialchars($mov['numero_empleado'] ?? 'â€”') ?></small>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                <label for="dias_pendientes_excel" class="form-label fw-semibold fs-5">DÃ­as pendientes (ref.)</label>
    ...
    <div class="card-footer bg-white py-3 d-flex justify-content-end gap-2">
        <a href="<?= url_path('/vacaciones/empleado/'.(int)$mov['personal_id']) ?>" class="btn btn-outline-secondary btn-lg">Cancelar</a>
