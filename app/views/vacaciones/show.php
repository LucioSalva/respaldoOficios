...
<div class="d-flex align-items-center gap-2 mb-3 flex-wrap">
    ...
    <a href="<?= url_path('/vacaciones/crear?personal_id='.(int)$persona['id']) ?>"
...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-body fs-5">
        <div class="row g-3">
            <div class="col-md-4">
                <small class="text-muted d-block">NÃºmero de empleado</small>
                <strong><?= htmlspecialchars($persona['numero_empleado'] ?? 'â€”') ?></strong>
            </div>
            <div class="col-md-4">
...
<div class="row g-3 mb-4">
    <?php if (empty($saldos)): ?>
        <div class="col-12">
            <div class="alert alert-light border fs-5">Este empleado aÃºn no tiene saldos registrados.</div>
        </div>
    <?php endif; ?>
        ...
        <table class="table table-hover mb-0 align-middle" style="font-size:1.05rem">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><code class="fs-6"><?= htmlspecialchars($m['folio_tm_vacaciones'] ?? 'â€”') ?></code></td>
                    <td>
                        <?php
                    ...
                    <td class="pe-4 text-center">
                        ...
                        <div class="btn-group">
                            <a href="<?= url_path('/vacaciones/mov/'.(int)$m['id'].'/editar') ?>"
                               class="btn btn-outline-primary btn-lg" title="Editar">
                                <i class="fa-solid fa-pen"></i>
                            </a>
                            <form method="POST"
                                  action="<?= url_path('/vacaciones/mov/'.(int)$m['id'].'/cancelar') ?>"
                                  class="d-inline"
                                  data-confirm="Â¿Cancelar este movimiento? El saldo se recalcularÃ¡."
                                  data-confirm-title="Cancelar movimiento"
                                  data-confirm-btn="SÃ­, cancelar"
