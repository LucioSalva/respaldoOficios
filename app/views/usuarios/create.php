...
<div class="card border-0 shadow-sm" style="max-width:700px;">
    <div class="card-body p-4 p-md-5">
        <form method="POST" action="<?= url_path('/usuarios/crear') ?>" novalidate>
            ...
            <div class="mb-4">
                ...
                <?php else: ?>
                <small class="text-muted">Solo letras, n̼meros y guiones. Sin espacios.</small>
                <?php endif; ?>
            </div>
            ...
            <div class="mb-4">
                ...
                <?php else: ?>
                <small class="text-muted">La contrase̱a debe tener al menos 8 caracteres.</small>
                <?php endif; ?>
            </div>
