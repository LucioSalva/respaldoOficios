...
<div class="card border-0 shadow-sm">
    <div class="card-body">
        <form method="POST" action="<?= url_path('/personal/crear') ?>" novalidate>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" id="categoria" name="categoria" maxlength="120"
                           ...
                           placeholder="Ej. Auxiliar, Coordinador Lâ€¦">
                </div>
            ...
            <div class="d-flex gap-2 mt-4">
                ...
                <a href="<?= url_path('/personal') ?>" class="btn btn-outline-secondary btn-lg">Cancelar</a>
            </div>
        </form>
    </div>
</div>
