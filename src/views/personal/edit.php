...
<div class="d-flex align-items-center justify-content-between mb-4">
    ...
    <a href="/personal/<?= (int)$persona['id'] ?>" class="btn btn-outline-secondary btn-lg">
...
<div class="card border-0 shadow-sm">
    <div class="card-body">
        <form method="POST" action="/personal/<?= (int)$persona['id'] ?>/editar" novalidate>
            ...
            <div class="d-flex gap-2 mt-4">
                ...
                <a href="/personal/<?= (int)$persona['id'] ?>" class="btn btn-outline-secondary btn-lg">Cancelar</a>
            </div>
        </form>
    </div>
</div>
