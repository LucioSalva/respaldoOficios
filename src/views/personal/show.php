...
<div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
    ...
    <div class="d-flex gap-2">
        ...
        <a href="/personal/<?= (int)$persona['id'] ?>/editar" class="btn btn-outline-secondary btn-lg">
...
<div class="row g-3 mb-4">
    <div class="col-md-3">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body">
                <p class="text-muted small mb-1">Número de empleado</p>
                <p class="h4 fw-bold mb-0"><?= htmlspecialchars($persona['numero_empleado'] ?? '—') ?></p>
            </div>
        </div>
    </div>
    <div class="col-md-3">
    ...
    <div class="col-md-3">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body">
                ...
                <p class="h5 mb-0"><?= htmlspecialchars($persona['categoria'] ?? '—') ?></p>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body">
                ...
                <p class="h6 mb-0"><?= htmlspecialchars($persona['horario'] ?? '—') ?></p>
            </div>
        </div>
    </div>
</div>
...
<div class="card border-0 shadow-sm mb-3">
    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
        ...
        <a href="/vacaciones/crear?personal_id=<?= (int)$persona['id'] ?>" class="btn btn-institucional">
        ...
        <table class="table table-hover table-lg mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $h['fecha_inicio'] ? date('d/m/Y', strtotime($h['fecha_inicio'])) : '—' ?></td>
                    <td><?= $h['fecha_fin']    ? date('d/m/Y', strtotime($h['fecha_fin']))    : '—' ?></td>
                    <td><?= $h['fecha_regreso']? date('d/m/Y', strtotime($h['fecha_regreso'])): '—' ?></td>
                    ...
                    <td class="text-center">
                        <a href="/vacaciones/<?= (int)$h['id'] ?>" class="btn btn-sm btn-outline-secondary">
...
<div class="card border-0 shadow-sm mb-3">
    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center flex-wrap gap-2">
        ...
        <div class="d-flex gap-2 flex-wrap">
            <a href="/incidencias?q=<?= urlencode($persona['numero_empleado'] ?? '') ?>" class="btn btn-outline-secondary">
                <i class="fa-solid fa-list me-1"></i>Ver todas
            </a>
            <a href="/incidencias/crear?personal_id=<?= (int)$persona['id'] ?>" class="btn btn-institucional">
    ...
    <div class="card-body bg-light border-bottom">
        <div class="row g-2 text-center">
            ...
            <div class="col-6 col-md-3 col-lg-2">
                <div class="p-2 rounded bg-white border">
                    <small class="text-muted d-block">Omisión entrada</small>
                    <strong class="h5 mb-0"><?= (int)($incidenciasResumen['omision_entrada'] ?? 0) ?></strong>
                </div>
            </div>
            <div class="col-6 col-md-3 col-lg-2">
                <div class="p-2 rounded bg-white border">
                    <small class="text-muted d-block">Omisión salida</small>
        ...
        <table class="table table-hover table-lg mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="/incidencias/<?= (int)$i['id'] ?>" class="btn btn-sm btn-outline-secondary">
                            <i class="fa-solid fa-eye"></i>
                        </a>
                    </td>
                </tr>
