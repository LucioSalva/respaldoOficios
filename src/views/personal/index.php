...
<div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
    ...
    <a href="/personal/crear" class="btn btn-institucional btn-lg">
...
<div class="card border-0 shadow-sm mb-3">
    <div class="card-body">
        <form method="GET" action="/personal" class="row g-2 align-items-end">
            <div class="col-md-3">
            ...
            <div class="col-md-2">
                <label for="f_num" class="form-label fw-semibold">N° empleado</label>
    ...
    <div class="table-responsive">
        <table class="table table-hover table-lg mb-0" aria-label="Lista de personal">
            <thead class="table-light">
                <tr>
                    <th scope="col" class="ps-4">N° empleado</th>
            ...
            <?php foreach ($personal as $p): ?>
                <tr class="<?= !$p['activo'] ? 'table-secondary opacity-75' : '' ?>">
                    <td class="ps-4 fw-semibold"><?= htmlspecialchars($p['numero_empleado'] ?? '—') ?></td>
                    ...
                    <td class="pe-4 text-center">
                        <div class="d-flex gap-2 justify-content-center">
                            <a href="/personal/<?= (int)$p['id'] ?>" class="btn btn-sm btn-outline-secondary" title="Ver">
                                <i class="fa-solid fa-eye"></i>
                            </a>
                            <?php if (Auth::hasRole([ROL_GOD, ROL_ADMIN])): ?>
                            <a href="/personal/<?= (int)$p['id'] ?>/editar" class="btn btn-sm btn-outline-secondary" title="Editar">
