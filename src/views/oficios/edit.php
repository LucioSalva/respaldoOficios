        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item">
                    <a href="/oficios/<?= $oficio['id'] ?>"><?= htmlspecialchars($__folio_bread) ?></a>
                </li>
...
<form method="POST" action="/oficios/<?= $oficio['id'] ?>/editar"
    ...
    <div class="alert d-flex align-items-center gap-3 mb-4 border-0 shadow-sm"
        ...
        <div>
            ...
            <div class="mt-1 small text-info-emphasis">
                ...
                <strong>Este oficio no requiere contestación.</strong>
            </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm mb-4">
        ...
        <div class="card-body p-4">
            ...
            <p class="text-muted small mb-3">
                ...
                Ya existe un PDF. Si subes uno nuevo, reemplazará al anterior.
            </p>
            <?php endif; ?>
            <div class="row g-3 align-items-center">
                <div class="col-12 col-md-8">
                    ...
                    <small class="text-muted" id="info_pdf_recibido">
                        <i class="fa-solid fa-circle-info me-1"></i>Solo archivos PDF. Tamaño máximo: 10 MB.
                    </small>
                </div>
                <div class="col-12 col-md-4">
    ...
    <div class="d-flex gap-3 flex-wrap pb-4">
        ...
        <a href="/oficios/<?= $oficio['id'] ?>" class="btn btn-outline-secondary btn-lg px-5 py-3">
