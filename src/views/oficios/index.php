...
<div class="d-flex align-items-center justify-content-between mb-4">
    ...
    <a href="/oficios/crear" class="btn btn-institucional btn-lg">
...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-header bg-white border-bottom py-3">
        <h2 class="h6 fw-bold mb-0 text-muted">
            <i class="fa-solid fa-filter me-2" aria-hidden="true"></i>Filtros de Búsqueda
        </h2>
    </div>
    <div class="card-body">
        <form method="GET" action="/oficios" novalidate>
            <div class="row g-3">
                <!-- Tipo de oficio -->
                ...
                <div class="col-12 col-md-4 col-lg-3">
                    ...
                    <input type="text" class="form-control" id="f_folio" name="folio"
                           ...
                           placeholder="Busca en Tesorería / Interno / Dirección">
                </div>
                ...
                <div class="col-12 col-md-4 col-lg-2">
                    <label for="f_area" class="form-label fw-semibold">Área Interna</label>
            ...
            <div class="mt-3 d-flex gap-2">
                ...
                <a href="/oficios" class="btn btn-outline-secondary btn-lg px-4">
...
<div class="card border-0 shadow-sm">
    ...
    <div class="card-body text-center py-5 text-muted">
        ...
        <a href="/oficios/crear" class="btn btn-institucional mt-2">Registrar nuevo oficio</a>
    </div>
    <?php else: ?>
        ...
        <table class="table table-hover table-lg mb-0" aria-label="Lista de oficios">
            <thead class="table-light">
                <tr>
                    ...
                    <th scope="col">Dependencia / Área Interna</th>
            ...
            <?php foreach ($oficios as $oficio):
                ...
                if ($es_int) {
                    $origen = $oficio['area_interna'] ?? '—';
                } elseif ($es_con) {
                    $origen = $oficio['dependencia'] ?? 'Sin dependencia';
                } else {
                    $origen = $oficio['dependencia'] ?? '—';
                }
            ?>
                <tr>
                    <td class="ps-4">
    ...
    <div class="card-footer bg-white border-top">
        <nav aria-label="Paginación de oficios">
        ...
        <p class="text-center text-muted small mt-2">Página <?= $pagina ?> de <?= $paginas ?></p>
    </div>
    <?php endif; ?>
    <?php endif; ?>
</div>
