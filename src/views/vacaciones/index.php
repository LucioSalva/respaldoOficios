...
<div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
    ...
    <div class="d-flex flex-wrap gap-2">
        ...
        <a href="/vacaciones/inconsistencias" class="btn btn-outline-danger btn-lg">
        ...
        <?php endif; ?>
        <a href="/vacaciones/crear" class="btn btn-institucional btn-lg">
...
<div class="card border-0 shadow-sm mb-3">
    <div class="card-body">
        <form method="GET" action="/vacaciones" class="row g-3 align-items-end">
            <div class="col-md-4">
            ...
            <div class="col-md-2">
                <label for="f_num" class="form-label fw-semibold fs-6">Número</label>
            ...
            <div class="col-md-2">
                <label for="f_periodo" class="form-label fw-semibold fs-6">Periodo con días</label>
            ...
            <div class="col-md-2">
                ...
                <select id="f_orden" name="orden" class="form-select form-select-lg">
                    ...
                    <option value="num"          <?= $filtros['orden'] === 'num' ? 'selected' : '' ?>>Número de empleado</option>
            ...
            <div class="col-md-2 d-flex align-items-end">
                <div class="form-check form-switch fs-5">
                    ...
                    <label class="form-check-label" for="f_bajos">Pocos días (≤ 2)</label>
                </div>
            </div>
            ...
            <div class="col-12 d-flex gap-2">
                ...
                <a href="/vacaciones" class="btn btn-outline-secondary btn-lg">Limpiar</a>
            </div>
        </form>
    </div>
</div>
    ...
    <div class="table-responsive">
        <table class="table table-hover mb-0 align-middle" style="font-size:1.05rem">
            ...
            <tbody>
                ...
                <tr>
                    <td class="ps-4"><strong><?= htmlspecialchars($r['numero_empleado'] ?? '—') ?></strong></td>
                    <td>
                    ...
                    <td class="pe-4 text-center">
                        <a href="/vacaciones/empleado/<?= (int)$r['personal_id'] ?>"
