...
<div class="card border-0 shadow-sm mb-4" style="border-left:6px solid #495057 !important;">
    <div class="card-body d-flex align-items-center gap-3 flex-wrap">
        ...
        <a href="/oficios?tipo=CONOCIMIENTO" class="btn btn-outline-dark btn-lg">
...
<div class="row g-3 mb-4">
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
        <a href="/oficios/crear" class="btn btn-institucional btn-accion-rapida w-100 py-4">
            <i class="fa-solid fa-circle-plus display-6 d-block mb-2" aria-hidden="true"></i>
            <span class="fw-bold fs-5">Nuevo Oficio</span>
        </a>
    </div>
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
        <a href="/oficios" class="btn btn-outline-institucional btn-accion-rapida w-100 py-4">
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
        <a href="/usuarios" class="btn btn-outline-secondary btn-accion-rapida w-100 py-4">
            <i class="fa-solid fa-users display-6 d-block mb-2" aria-hidden="true"></i>
            <span class="fw-bold fs-5">Gestionar Usuarios</span>
        </a>
    </div>
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
        <a href="/catalogos" class="btn btn-outline-secondary btn-accion-rapida w-100 py-4">
...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white border-bottom d-flex justify-content-between align-items-center py-3">
        ...
        <a href="/oficios" class="btn btn-sm btn-outline-institucional">
    ...
    <div class="card-body p-0">
        ...
        <div class="text-center py-5 text-muted">
            ...
            <a href="/oficios/crear" class="btn btn-institucional">Registrar primer oficio</a>
        </div>
        <?php else: ?>
            ...
            <table class="table table-hover table-lg mb-0">
                ...
                <?php foreach ($ultimos_oficios as $oficio): ?>
                    <tr>
                        ...
                        <td class="pe-4">
                            <a href="/oficios/<?= $oficio['id'] ?>" class="btn btn-sm btn-outline-primary">
...
<div class="card border-0 shadow-sm mt-4">
    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
        ...
        <a href="/incidencias" class="btn btn-outline-institucional">Ver todas</a>
    </div>
    <div class="card-body">
